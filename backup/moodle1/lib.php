...
/**
 * Block conversion handler for analytics
 */
class moodle1_block_analytics_handler extends moodle1_block_handler {
    ...
    protected function convert_configdata(array $olddata) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'block_analytics');
