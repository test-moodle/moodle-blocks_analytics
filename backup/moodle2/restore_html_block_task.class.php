...
/**
 * Specialised restore task for the analytics block
...
class restore_analytics_block_task extends restore_block_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_analytics_block_decode_content('block_instances', 'configdata', 'block_instance');
 ...
 */
class restore_analytics_block_decode_content extends restore_decode_content {
